...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        ngtemplates: {
            app : {
                ...
                dest: '<%= builddir %>/paris1.personator_view.js',
                concat: 'dist',
                options: {
                    url: function (url) {
                        url = url.substr(0, 4) === 'src/' ? url.substr(4) : url;
                        return 'paris1.personator/'+url;
                    },
                    module: 'paris1.personator'
                }
            }
        },
    ...
    // --- Task About CSS
    grunt.registerTask('css', "Build css stuff", ['copy:styles','concat:css','cssmin', 'copy:font']);
