...
angular.module('paris1.user.style.editor')
    .directive('demoStyleEditor', ['$log',function($log){
        return {
            templateUrl : 'paris1.personator/modules/style/directives/editor/view.html',
            scope : {
                json        : '=?',
                callback    : '=?',
                options     : '=?',
